...
export function DebouncedInput({
  ...
  return (
    <div className="flex items-center justify-center rounded bg-[#e8eef4] pr-[19px]">
      <input
        {...props}
        className="placeholder:text-mauve-9 focus:border-purple-9 block w-full rounded bg-[#e8eef4] py-2.5 pl-[19px] pr-[40px] text-[14px] text-[#898989] transition duration-500 ease-in-out focus:outline-0
                 focus:ring-main-gray-bg-darkerNavy md:text-sm"
        value={value}
